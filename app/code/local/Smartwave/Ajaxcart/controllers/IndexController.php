		...
		if($params['isAjax'] == 1){
			...
			try {
				...
				if (!$cart->getQuote()->getHasError()){
					...
					$message = '<div class="msg">'.$this->__("O Produto foi adicionado com sucesso ao carrinho:").'<p class="product-name theme-color">'.Mage::helper('core')->htmlEscape($product->getName()).'</p><div class="timer theme-color">'.$autoclose.'</div></div>'.$product_image;
